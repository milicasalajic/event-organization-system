...
function PregledRezervacijaRestoranaPage() {
    ...
    const [aktivnaRezervacijaId, setAktivnaRezervacijaId] = useState(null);
    const [detaljiPoRezervaciji, setDetaljiPoRezervaciji] = useState({});
    ...
    useEffect(() => {
        async function loadPage() {
            ...
            try {
                ...
                setRezervacije(rezervacijeResult);
            } catch (error) {
    ...
    async function handleRezervacijaClick(rezervacijaId) {
        ...
        try {
            const detalji = await getRezervacijaDetalji(
                restoranId,
                rezervacijaId,
            );
    ...
    async function handlePromenaStatusa(rezervacijaId, noviStatus) {
        setObradaLoadingId(rezervacijaId);
        ...
        try {
            const rezultat = await obradiRezervaciju(
                restoranId,
                rezervacijaId,
                noviStatus,
            );
            ...
            <main className="pregled-rezervacija-container">
                ...
                <div className="rezervacije-heading">
                    <div>
                        ...
                        <p>
                            Pregled svih rezervacija koje pripadaju ovom restoranu.
                        </p>
                    </div>
                </div>
